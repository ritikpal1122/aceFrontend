...
const resources = [
  { type: "article", title: "Big-O Notation for Frontend Developers", url: "#" },
  { type: "video", title: "Data Structures You Need to Know", url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" },
  { type: "article", title: "Implementing Common Algorithms in JavaScript", url: "#" },
  { type: "video", title: "Solving LeetCode Problems for Frontend Interviews", url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" },
]
      ...
      <main className="container px-4 py-12 md:px-6">
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl">DSA For Frontend</h1>
            <p className="max-w-[900px] text-gray-500 md:text-xl dark:text-gray-400">
              Master Data Structures and Algorithms essential for frontend development. Learn how to approach and solve common coding challenges in frontend interviews.
            </p>
          </div>
